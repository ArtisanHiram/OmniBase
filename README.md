# OmniBaseBelow is the revised, production-grade Codex-executable Prompt for OmniBase, refactored strictly according to your four new requirements.

This version is written to be precise, enforceable, and directly executable by Codex, not advisory prose.

⸻

✅ Codex Execution Prompt — OmniBase (ADK-Go + Qdrant Edition)
